...
class PopupStudentDetail extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
    ...
    this.languageStudy = React.createRef()
  ...
  ShowPopupPrivacy() {
    ...
    let languageStudyOptions = this.languageStudy.current
    ...
    let languageStudy = languageStudyOptions.options[languageStudyOptions.selectedIndex].text
    ...
    newState.languageStudy = languageStudy
    ...
    return (
      <div>
        <Popup  open={this.state.isShowPopupDetail}>
          <div id="div-popup-student-detail">
            <h1 style={style}>Welcome student {this.props.data.firstName} </h1>
            <div className="row">
              <div className="col-md-3"></div>
              <div className="col-md-3">
                <label name="Language teach"> Language study </label>
              </div>
              <div className="col-md-4">
                <select ref={this.languageStudy}>
...
export default PopupStudentDetail